...
export const AddToPlaylist = ({ videoId, menu }) => {
  ...
  return (
    <div className=" flex flex-col space-y-2 w-auto h-auto mx-2 my-2 rounded-xl p-2 absolute left-54 top-auto z-80 bg-white shadow-lg ">
      <Input
