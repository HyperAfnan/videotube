...
export const chunkedUploadValidator = [
   param("uploadId")
      .notEmpty()
      .withMessage("uploadId is required")
      .isString()
      .withMessage("uploadId must be string"),
   body("partNumber")
      .notEmpty()
      .withMessage("partNumber is required")
      .isNumeric()
      .withMessage("partNumber must be number"),
   body("key")
      .notEmpty()
...
export const completeChunkedUploadValidator = [
   param("uploadId")
      .notEmpty()
      .withMessage("uploadId is required")
      .isString()
   ...
   body("parts")
      ...
      .isArray({ min: 1 })
      .withMessage("parts must be an array with at least one part"),
   body("key")
      .notEmpty()
      .withMessage("key is required")
      .isString()
